...
def parse_args():
    ...
    parser.add_argument('--name', default="egp",
...
forecast_label = 'E:\\paper1\\lidc\\UNET\\forecast_label' #预测标签转换成图片的地址
forecast_label_npy = "E:\\paper1\\lidc\\UNET\\forecast_label_npy"
labelnpytoimg_dir = 'E:\\paper1\\lidc\\UNET\\labelnpytoimg_dir' #将labelnpy转换成图片保存的地址
imgnpytoimg_dir = "E:\\paper1\\lidc\\UNET\\imgnpytoimg_dir"
img_dir = 'testdata/img_npy'  #原始图片npy
label_dir = 'testdata/label'  #原始标签
imgandlabel = "E:\\paper1\\lidc\\UNET\\imgandlabel"
imgandlabel2 = "E:\\paper1\\lidc\\UNET\\imgandlabel2"

label_npy_roc_pr = r"E:\\paper1\\lidc\\UNET\\label_npy_roc_pr"
forecast_label_npy_roc_pr = r'E:\\paper1\\lidc\\UNET\\forecast_label_npy_roc_pr'
...
model.load_state_dict(torch.load(('xin_my_pro/gonggong/{}_base/bestmodel_5e-05_CosineAnnealingLR.pth').format(config["name"])))
model.cuda()
