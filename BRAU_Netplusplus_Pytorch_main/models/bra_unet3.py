...
from BRAU_Netplusplus_Pytorch_main.models.bra_unet_system import BRAUnetSystem
...
if __name__ == '__main__':
    ras = BRAUnet(img_size=128, in_chans=1, n_win=4).cuda()
