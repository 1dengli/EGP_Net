...
from UNet3P.models.layers import unetConv2
from UNet3P.models.init_weights import init_weights
import numpy as np
'''
    UNet img_npy+
'''
class UNet_3Plus(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        ...
        # h3->80*80, hd4->40*40, Pooling image times
        ...
        # hd5->20*20, hd4->40*40, Upsample image times
        ...
        # h2->160*160, hd3->80*80, Pooling image times
        ...
        # hd4->40*40, hd4->80*80, Upsample image times
        ...
        '''stage 2d '''
        # h1->320*320, hd2->160*160, Pooling image times
        ...
        # hd3->80*80, hd2->160*160, Upsample image times
        ...
        # hd2->160*160, hd1->320*320, Upsample image times
...
'''
    UNet img_npy+ with deep supervision
'''
...
'''
    UNet img_npy+ with deep supervision and class-guided module
'''
class UNet_3Plus_DeepSup_CGM(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # -------------Classification-------------
        cls_branch = self.cls(hd5).squeeze(3).squeeze(2)  # (B,N,label,label)->(B,N)
...
if __name__ == '__main__':
    unet3p = UNet_3Plus(in_channels=1,n_classes=1)
    rgb = torch.randn([1, 1, 128, 128])
    out1 =unet3p(rgb)

    flops, params = profile(unet3p, inputs=(rgb,))
    flop_g = flops / (10 ** 9)
