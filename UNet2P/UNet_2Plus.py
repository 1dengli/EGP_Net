...
class Unet2_Plus(nn.Module):
    def __init__(self, C, num_classes, deep_supervision=False):
        super(Unet2_Plus, self).__init__()
        ...
        self.stage_0 = ContinusParalleConv(C, 64, pre_Batch_Norm=False)
...
#     model = Unet2_Plus(num_classes=1).to(device)
#     print(summary(model, (1,128,128)))

if __name__ == '__main__':
    ras = Unet2_Plus(C=1, num_classes=1).cuda()
